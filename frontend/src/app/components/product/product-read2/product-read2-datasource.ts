 ...
 */
export class ProductRead2DataSource extends DataSource<ProductInterface> {
  data: ProductInterface[] = EXAMPLE_DATA;
   ...
   */
  private getPagedData(data: ProductInterface[]): ProductInterface[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: ProductInterface[]): ProductInterface[] {
